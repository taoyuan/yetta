 ...
 * Examples:
 *
 *   yetta.phase(configure('config/environments'));
 *
 *   yetta.phase(configure({ dirname: 'config/environments', env: 'test' }));
 *
...
module.exports = function(options) {
    ...
    return function configure() {
        var dirname = options.dirname || 'config/environments';
        var env = options.env || this.env;
